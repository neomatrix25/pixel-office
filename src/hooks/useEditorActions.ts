...
// Note: vscode.postMessage now routes through the event bus (see vscodeApi.ts).
// Layout saves are emitted as 'saveLayout' events that a future backend can handle.
